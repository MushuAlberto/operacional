...
if archivo is not None:
    try:
        ...
        if 'Base de Datos' not in xls.sheet_names:
            ...
            # Leer la hoja 'Base de Datos' sin encabezado
            df = pd.read_excel(xls, sheet_name='Base de Datos', header=None)

            # Renombrar columnas por posición (B=índice 1, E=4, F=5)
            ...
            # Convertir columna Fecha a tipo datetime y filtrar desde 2025
